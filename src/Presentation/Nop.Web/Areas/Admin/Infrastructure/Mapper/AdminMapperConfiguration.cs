    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateTaxMaps()
        {
            ...
            CreateMap<TaxSettings, TaxSettingsModel>()
                ...
                .ForMember(model => model.HrOibAssumeValid_OverrideForStore, options => options.Ignore())
                .ForMember(model => model.HrOibEmailAdminWhenNewOibSubmitted_OverrideForStore, options => options.Ignore())
                .ForMember(model => model.HrOibEnabled_OverrideForStore, options => options.Ignore())
                .ForMember(model => model.HrOibShopCountries, options => options.Ignore())
                .ForMember(model => model.HrOibShopCountryId_OverrideForStore, options => options.Ignore())
